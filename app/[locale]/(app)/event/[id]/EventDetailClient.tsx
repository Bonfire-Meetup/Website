      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-5xl px-4 pb-24">
          <div className="flex flex-col gap-6 lg:contents">
            {hasSpeakers && (
              <div className="glass order-1 rounded-3xl p-6 sm:p-8 lg:col-start-1">
                ...
                <div className="space-y-4">
                  {confirmedSpeakers.map((speaker, index) => (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-bold text-neutral-900 dark:text-white">{speaker.name}</p>
            ...
            <div className="glass relative order-2 overflow-hidden rounded-3xl p-6 sm:p-8 lg:col-start-1">
              <div
            ...
            <div className="glass order-4 rounded-3xl p-6 lg:col-start-2">
