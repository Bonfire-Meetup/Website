  ...
  return (
    <main className="gradient-bg min-h-screen pt-28 pb-24">
      <div className="mx-auto max-w-6xl space-y-20 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
              {stats.map((stat) => (
                <div key={stat.label} className="text-center sm:text-left">
                  <div
                    className={`font-bold text-neutral-900 dark:text-white ${stat.emphasis === "sm" ? "text-lg sm:text-xl" : "text-2xl sm:text-3xl"}`}
                  >
                    {stat.value}
                  </div>
        ...
        <section className="glass-card no-hover-pop p-8 text-center sm:p-12">
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">{t("help.title")}</h2>
