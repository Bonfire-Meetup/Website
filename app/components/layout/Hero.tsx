...
export function Hero({ images, trendingRecordings = [] }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-neutral-50 px-4 pt-[9.8rem] pb-[4.8rem] transition-colors duration-500 sm:px-6 sm:pt-[11rem] sm:pb-[5.4rem] lg:px-8 lg:pt-[11.8rem] lg:pb-[6.1rem] dark:bg-neutral-950">
