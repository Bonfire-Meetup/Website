    ...
    <section className="relative px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        <div className="glass-card relative overflow-hidden p-8 sm:p-12">
          <div className="bg-brand-500/10 dark:bg-brand-500/20 pointer-events-none absolute -top-20 -right-20 h-64 w-64 rounded-full blur-3xl" />
          <div className="bg-fire-end/10 dark:bg-fire-end/20 pointer-events-none absolute -bottom-20 -left-20 h-64 w-64 rounded-full blur-3xl" />
